...
Install [this application](FIXME) to a Google Kubernetes Engine cluster using Google Cloud Marketplace.
...
2. From the list of applications, click FIXME.
3. On the Application Details page, click <kbd>Delete</kbd>.
