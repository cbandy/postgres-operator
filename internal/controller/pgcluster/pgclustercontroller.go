...
func (c *Controller) processNextItem() bool {
	...
	err = kubeapi.PatchpgclusterStatus(c.Client.Discovery().RESTClient(), state, message, cluster, keyNamespace)
	if err != nil {
	...
	clusterInfo, err := clusteroperator.ScaleClusterDeployments(c.Client,
